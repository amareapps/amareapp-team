    ...
    class NotificationHelper : INotification
    {
        ...
        public void CreateNotification(String title, String message)
        {
            try
            {
                ...
                var sound = global::Android.Net.Uri.Parse(ContentResolver.SchemeAndroidResource + "://" + mContext.PackageName + "/" + Resource.Raw.swiftly);
                ...
                mBuilder.SetSmallIcon(Resource.Drawable.Amare_logo);
                mBuilder.SetContentTitle(title)
                        ...
                        .SetSmallIcon(Resource.Drawable.Amare_logo)
